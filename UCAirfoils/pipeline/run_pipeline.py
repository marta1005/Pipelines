"""
UCAirfoils Surrogate Factory — Standalone Pipeline Runner
==========================================================
Trains an MLP surrogate for aerodynamic coefficients (Cl, Cd, Cm)
from Kulfan CST airfoil parametrisation + flight conditions (alpha, Re).

Data generated with NeuralFoil (8k samples, NACA 0012 baseline + perturbations).
...
print("=" * 65)
print("  UCAirfoils — Surrogate Factory Pipeline")
print("=" * 65)
