...
\begin{center}
  ...
  {\small\color{sepgray} Use case: \textbf{UCAIRFOILS\_1} \quad|\quad 09 September 2026 \quad|\quad 1 model(s)}
\end{center}
...
\textbf{CL} & 23,952 & -0.363 & 0.537 & -0.000348 & $^{\text{-1.17e-05}}_{-0.000632}$ & -0.0012 & $^{-0.001}_{-0.0015}$ & 0.0249 & $^{0.026}_{0.0239}$ & 0.0213 & $^{0.0217}_{0.0209}$ & 54.4 & $^{70.5}_{34.5}$ & 2.21 & $^{3.36}_{0.82}$ \\ \hline
\textbf{CD} & 23,952 & -0.0661 & 0.0762 & -1.37e-05 & $^{\text{8.18e-06}}_{\text{-4.52e-05}}$ & -6.26e-06 & $^{\text{-3.02e-06}}_{\text{-9.89e-06}}$ & 0.0022 & $^{0.0024}_{0.0019}$ & 0.000346 & $^{0.000351}_{0.000339}$ & 307 & $^{386}_{221}$ & 5.98 & $^{11}_{0.392}$ \\ \hline
\textbf{CM} & 23,952 & -0.0296 & 0.0395 & -0.000119 & $^{\text{-7.96e-05}}_{-0.000151}$ & -0.000183 & $^{-0.000158}_{-0.000205}$ & 0.0031 & $^{0.0031}_{0.003}$ & 0.0022 & $^{0.0022}_{0.0022}$ & 17 & $^{20.6}_{14.2}$ & 1.04 & $^{1.5}_{0.636}$ \\ \hline
\textbf{top\_transition\_location} & 23,952 & -0.304 & 0.211 & 0.0028 & $^{0.003}_{0.0025}$ & 0.0018 & $^{0.002}_{0.0016}$ & 0.0178 & $^{0.0184}_{0.0172}$ & 0.0152 & $^{0.0154}_{0.015}$ & 20.3 & $^{27.6}_{15.1}$ & 0.0865 & $^{0.781}_{-0.554}$ \\ \hline
\textbf{bottom\_transition\_location} & 23,952 & -0.496 & 0.428 & -0.0053 & $^{-0.005}_{-0.0057}$ & -0.0053 & $^{-0.0052}_{-0.0055}$ & 0.0278 & $^{0.0289}_{0.027}$ & 0.016 & $^{0.0162}_{0.0157}$ & 33.7 & $^{42}_{28.1}$ & 0.483 & $^{1.34}_{-0.295}$ \\ \hline
\end{tabular}
}
\par\vspace{2pt}
...
\hline
\textbf{} & \textbf{count} & \textbf{min} & \textbf{max} & \textbf{mean} & \textbf{(BS)mean} & \textbf{median} & \textbf{(BS)median} & \textbf{std} & \textbf{(BS)std} & \textbf{IQR} & \textbf{(BS)IQR} & \textbf{kurtosis} & \textbf{(BS)kurtosis} & \textbf{skewness} & \textbf{(BS)skewness} \\ \hline
\textbf{CL} & 23,952 & 1.28e-06 & 0.537 & 0.0153 & $^{0.0156}_{0.0151}$ & 0.0106 & $^{0.0108}_{0.0104}$ & 0.0196 & $^{0.0209}_{0.0183}$ & 0.0143 & $^{0.0145}_{0.0141}$ & 118 & $^{149}_{74.4}$ & 7.55 & $^{8.75}_{6.06}$ \\ \hline
\textbf{CD} & 23,952 & 1.09e-08 & 0.0762 & 0.000577 & $^{0.000599}_{0.000559}$ & 0.00017 & $^{0.000173}_{0.000167}$ & 0.0021 & $^{0.0023}_{0.0019}$ & 0.000343 & $^{0.000352}_{0.000336}$ & 339 & $^{432}_{219}$ & 15.1 & $^{17.1}_{12.6}$ \\ \hline
\textbf{CM} & 23,952 & 1.46e-07 & 0.0395 & 0.0018 & $^{0.0019}_{0.0018}$ & 0.0011 & $^{0.0011}_{0.0011}$ & 0.0024 & $^{0.0025}_{0.0024}$ & 0.0016 & $^{0.0017}_{0.0016}$ & 29 & $^{34.3}_{23.8}$ & 4.23 & $^{4.54}_{3.93}$ \\ \hline
\textbf{top\_transition\_location} & 23,952 & 1.01e-06 & 0.304 & 0.0114 & $^{0.0116}_{0.0113}$ & 0.0076 & $^{0.0077}_{0.0075}$ & 0.0139 & $^{0.0145}_{0.0135}$ & 0.011 & $^{0.0111}_{0.0108}$ & 39.9 & $^{52.6}_{29.1}$ & 4.61 & $^{5.22}_{4.1}$ \\ \hline
\textbf{bottom\_transition\_location} & 23,952 & 1.47e-07 & 0.496 & 0.0157 & $^{0.0159}_{0.0154}$ & 0.0093 & $^{0.0094}_{0.0091}$ & 0.0236 & $^{0.0245}_{0.0227}$ & 0.0136 & $^{0.0138}_{0.0134}$ & 50.1 & $^{64.7}_{37.7}$ & 5.58 & $^{6.22}_{5.03}$ \\ \hline
\end{tabular}
}
\par\vspace{2pt}
...
\hline
\textbf{} & \textbf{CL} & \textbf{CD} & \textbf{CM} & \textbf{top\_transition\_location} & \textbf{bottom\_transition\_location} \\ \hline
\textbf{Pearson coeff.} & 0.0753 & 0.0924 & 0.0239 & 0.2219 & -0.000464 \\ \hline
\textbf{p-value} & 1.67e-31 & 1.34e-46 & 0.000214 & 6.61e-265 & 0.9427 \\ \hline
\textbf{Slope (normalized)} & 0.0093 & 0.0155 & 0.0075 & 0.0258 & -4.09e-05 \\ \hline
\end{tabular}
\par\vspace{2pt}
...
\hline
\textbf{} & \textbf{CL} & \textbf{CD} & \textbf{CM} & \textbf{top\_transition\_location} & \textbf{bottom\_transition\_location} \\ \hline
\textbf{Spearman coeff.} & 0.1481 & -0.0694 & -0.0303 & 0.2538 & -0.0889 \\ \hline
\textbf{p-value} & 1.72e-117 & 5.79e-27 & 2.75e-06 & 0 & 2.86e-43 \\ \hline
\end{tabular}
\par\vspace{2pt}
...
\hline
\textbf{} & \textbf{CL} & \textbf{CD} & \textbf{CM} & \textbf{top\_transition\_location} & \textbf{bottom\_transition\_location} \\ \hline
\textbf{Pearson coeff.} & -0.028 & 0.5805 & 0.1248 & 0.2174 & 0.2543 \\ \hline
\textbf{p-value} & 1.44e-05 & 0 & 9.69e-84 & 2.94e-254 & 0 \\ \hline
\textbf{Slope (normalized)} & -0.0046 & 0.1753 & 0.0546 & 0.0335 & 0.0354 \\ \hline
\end{tabular}
\par\vspace{2pt}
...
\hline
\textbf{} & \textbf{CL} & \textbf{CD} & \textbf{CM} & \textbf{top\_transition\_location} & \textbf{bottom\_transition\_location} \\ \hline
\textbf{Spearman coeff.} & -0.0051 & 0.6219 & 0.1056 & 0.2728 & 0.3721 \\ \hline
\textbf{p-value} & 0.4327 & 0 & 2.47e-60 & 0 & 0 \\ \hline
\end{tabular}
\par\vspace{2pt}
...
\textbf{Coverage} & 94.66 & 94.91 & 95.14 & 94.82 & 94.91 & \textemdash \\ \hline
\textbf{CI} & [94.36, 94.94] & [94.62, 95.19] & [94.86, 95.41] & [94.53, 95.1] & [94.62, 95.19] & \textemdash \\ \hline
\end{tabular}
\par\vspace{2pt}
