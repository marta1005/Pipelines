...
# SCRIPT_DIR = .../Pipelines/UCLoads/pipeline/python_nodes_library/model_validation
...
if __name__ == "__main__":
    ...
    parser.add_argument("--splitting_variables", nargs="+", type=str, default=None, help="List of variables to use for splitting the data")
    parser.add_argument("--save_as_notebook", action="store_true", help="Save the executed notebook instead of exporting to HTML")
    parser.add_argument("--omit_execution", action="store_true", help="Omit execution (useful for debugging)")
