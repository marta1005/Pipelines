"""
UCHardLanding Surrogate Factory — Standalone Pipeline Runner
============================================================
Runs all pipeline stages without Jupyter.

Usage (from project root or pipeline directory):
    python UCHardLanding/pipeline/run_pipeline.py
...
print("=" * 65)
print("  UCHardLanding — Surrogate Factory Pipeline")
print("=" * 65)
...
# 9.1 — predictions on test set, train set and val set
print("\n--- 9.1 Predictions ---")
...
# 9.5 — export validation CSVs (required by the reporting step)
...
# =============================================================================
# Reporting — generate PDF + HTML validation report
# =============================================================================
