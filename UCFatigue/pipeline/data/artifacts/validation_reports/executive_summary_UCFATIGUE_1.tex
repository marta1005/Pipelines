...
\begin{center}
  ...
  {\small\color{sepgray} Use case: \textbf{UCFATIGUE\_1} \quad|\quad 07 September 2026 \quad|\quad 2 model(s)}
\end{center}
...
\textbf{1g} & 174 & -9.66 & 1.97 & -0.21 & $^{-0.0724}_{-0.378}$ & -0.0456 & $^{0.0019}_{-0.127}$ & 1.16 & $^{1.52}_{0.679}$ & 0.594 & $^{0.712}_{0.408}$ & 29.2 & $^{46.8}_{5.69}$ & -4.36 & $^{-0.934}_{-5.52}$ \\ \hline
\textbf{Vertical maneuver} & 174 & -2.39 & 1.85 & -0.0341 & $^{0.0244}_{-0.079}$ & -0.0074 & $^{0.0265}_{-0.0332}$ & 0.419 & $^{0.496}_{0.312}$ & 0.224 & $^{0.263}_{0.193}$ & 10.8 & $^{15.8}_{6.01}$ & -1.61 & $^{0.541}_{-2.96}$ \\ \hline
\textbf{Vertical gust} & 174 & -0.127 & 0.0307 & -0.0024 & $^{-0.000455}_{-0.0046}$ & -0.0013 & $^{0.000254}_{-0.0025}$ & 0.0157 & $^{0.0209}_{0.0114}$ & 0.0097 & $^{0.0127}_{0.0085}$ & 23.7 & $^{35.6}_{4.22}$ & -3.64 & $^{-1.14}_{-4.55}$ \\ \hline
\textbf{Turn} & 174 & -0.84 & 0.881 & -0.0176 & $^{0.0077}_{-0.0391}$ & -0.0031 & $^{0.0136}_{-0.0131}$ & 0.184 & $^{0.216}_{0.142}$ & 0.0983 & $^{0.128}_{0.0713}$ & 8 & $^{12.3}_{4.72}$ & -0.788 & $^{1.02}_{-2.56}$ \\ \hline
\textbf{Frontal gust} & 174 & -0.249 & 0.628 & 0.0061 & $^{0.0153}_{-0.0023}$ & 9.16e-05 & $^{\text{9.16e-05}}_{\text{9.16e-05}}$ & 0.068 & $^{0.0992}_{0.0325}$ & 1.39e-17 & $^{0.00033}_{0}$ & 48.3 & $^{96.2}_{17.4}$ & 5.57 & $^{8.36}_{-2.71}$ \\ \hline
\textbf{n0} & 174 & -0.0583 & 0.0883 & 0.0022 & $^{0.0048}_{-0.000258}$ & 0.0014 & $^{0.0031}_{-0.002}$ & 0.0192 & $^{0.023}_{0.0155}$ & 0.015 & $^{0.0202}_{0.013}$ & 4.62 & $^{6.66}_{1.86}$ & 0.979 & $^{1.61}_{-0.107}$ \\ \hline
\textbf{Giro} & 174 & -1.55 & 1.51 & -0.034 & $^{-0.0016}_{-0.0769}$ & -0.0113 & $^{-0.0019}_{-0.0271}$ & 0.308 & $^{0.394}_{0.209}$ & 0.142 & $^{0.176}_{0.0961}$ & 11.1 & $^{17.9}_{6.48}$ & -0.253 & $^{1.65}_{-2.37}$ \\ \hline
\end{tabular}
}
\par\vspace{2pt}
...
\hline
\textbf{} & \textbf{count} & \textbf{min} & \textbf{max} & \textbf{mean} & \textbf{(BS)mean} & \textbf{median} & \textbf{(BS)median} & \textbf{std} & \textbf{(BS)std} & \textbf{IQR} & \textbf{(BS)IQR} & \textbf{kurtosis} & \textbf{(BS)kurtosis} & \textbf{skewness} & \textbf{(BS)skewness} \\ \hline
\textbf{1g} & 174 & 0.0028 & 9.66 & 0.572 & $^{0.721}_{0.451}$ & 0.246 & $^{0.363}_{0.223}$ & 1.03 & $^{1.43}_{0.526}$ & 0.55 & $^{0.68}_{0.412}$ & 39.7 & $^{63.1}_{6.25}$ & 5.57 & $^{6.94}_{2.21}$ \\ \hline
\textbf{Vertical maneuver} & 174 & 0.000887 & 2.39 & 0.229 & $^{0.284}_{0.187}$ & 0.113 & $^{0.137}_{0.0935}$ & 0.353 & $^{0.45}_{0.245}$ & 0.177 & $^{0.266}_{0.142}$ & 13.9 & $^{22.9}_{7.02}$ & 3.45 & $^{4.2}_{2.47}$ \\ \hline
\textbf{Vertical gust} & 174 & 3.12e-05 & 0.127 & 0.0088 & $^{0.0109}_{0.0072}$ & 0.0055 & $^{0.0061}_{0.0045}$ & 0.0132 & $^{0.0192}_{0.0075}$ & 0.0073 & $^{0.0093}_{0.0064}$ & 38.1 & $^{53.5}_{7.19}$ & 5.28 & $^{6.36}_{2.44}$ \\ \hline
\textbf{Turn} & 174 & 0.0016 & 0.881 & 0.105 & $^{0.126}_{0.0851}$ & 0.0513 & $^{0.0633}_{0.0376}$ & 0.153 & $^{0.184}_{0.111}$ & 0.0955 & $^{0.134}_{0.0714}$ & 9.81 & $^{14.5}_{5.55}$ & 3 & $^{3.49}_{2.38}$ \\ \hline
\textbf{Frontal gust} & 174 & 9.16e-05 & 0.628 & 0.0162 & $^{0.0265}_{0.0081}$ & 9.16e-05 & $^{\text{9.16e-05}}_{\text{9.16e-05}}$ & 0.0663 & $^{0.0968}_{0.0281}$ & 0.002 & $^{0.0059}_{0.000381}$ & 49.2 & $^{86}_{17.1}$ & 6.54 & $^{8.64}_{4.16}$ \\ \hline
\textbf{n0} & 174 & 5.6e-05 & 0.0883 & 0.013 & $^{0.0148}_{0.0111}$ & 0.0076 & $^{0.0099}_{0.0058}$ & 0.0143 & $^{0.0174}_{0.011}$ & 0.0141 & $^{0.0178}_{0.0113}$ & 8.74 & $^{11.9}_{2.44}$ & 2.52 & $^{2.93}_{1.47}$ \\ \hline
\textbf{Giro} & 174 & 0.0012 & 1.55 & 0.158 & $^{0.189}_{0.12}$ & 0.0569 & $^{0.0859}_{0.0448}$ & 0.266 & $^{0.332}_{0.193}$ & 0.149 & $^{0.185}_{0.0903}$ & 12.4 & $^{21.8}_{7.24}$ & 3.36 & $^{4.25}_{2.73}$ \\ \hline
\end{tabular}
}
\par\vspace{2pt}
...
\textbf{Coverage} & 96.55 & 94.25 & 94.83 & 95.4 & 94.83 & 96.55 & 91.95 & \textemdash \\ \hline
\textbf{CI} & [92.65, 98.72] & [89.68, 97.21] & [90.41, 97.61] & [91.14, 97.99] & [90.41, 97.61] & [92.65, 98.72] & [86.87, 95.53] & \textemdash \\ \hline
\end{tabular}
}
\par\vspace{2pt}
