...
\begin{center}
  ...
  {\small\color{sepgray} Use case: \textbf{UCFATIGUE\_1} \quad|\quad 04 August 2026 \quad|\quad 2 model(s)}
\end{center}
...
\begin{center}\includegraphics[width=\linewidth]{analysis_plots/data_scatter_vars.png}\end{center}
...
\begin{center}\includegraphics[width=\linewidth]{../scatter_GradientBoosting.png}\end{center}
...
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/data_input_stats.png}\end{center}
\exhead{Input Histograms}
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/data_input_hist.png}\end{center}
\exhead{Output Statistics}
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/data_output_stats.png}\end{center}
\exhead{Output Histograms}
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/data_output_hist.png}\end{center}
\exhead{Output Cumulative Distributions}
Vertical markers show P10, P50, and P90.
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/data_output_cdf.png}\end{center}
\clearpage
...
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/split_output_dists.png}\end{center}
\exhead{Input Distributions: Train vs Test}
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/split_input_dists.png}\end{center}
\exhead{KS and AD Test Results}
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/split_ks_ad_table.png}\end{center}
\clearpage
...
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/err_residue_stats.png}\end{center}
...
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/err_residue_hist.png}\end{center}
\exhead{Residue CDF}
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/err_residue_cdf.png}\end{center}
\exhead{Absolute Error Histograms}
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/err_abserr_hist.png}\end{center}
...
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/err_relerr_cdf.png}\end{center}
\begin{minipage}{\linewidth}
\renewcommand{\arraystretch}{1.2}
...
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/err_true_vs_pred_dist.png}\end{center}
\clearpage
...
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/pex_bias_heatmap.png}\end{center}
\clearpage
...
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/pex_violin_res_1g.png}\end{center}
\subsection*{\normalsize Residue --- Vertical maneuver}
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/pex_violin_res_Vertical_maneuver.png}\end{center}
\subsection*{\normalsize Residue --- Vertical gust}
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/pex_violin_res_Vertical_gust.png}\end{center}
\subsection*{\normalsize Residue --- Turn}
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/pex_violin_res_Turn.png}\end{center}
\subsection*{\normalsize Residue --- Frontal gust}
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/pex_violin_res_Frontal_gust.png}\end{center}
\subsection*{\normalsize Residue --- n0}
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/pex_violin_res_n0.png}\end{center}
\subsection*{\normalsize Residue --- Giro}
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/pex_violin_res_Giro.png}\end{center}
\clearpage
\exhead{Absolute Error Violin Plots per Output (binned by input)}
\subsection*{\normalsize Absolute Error --- 1g}
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/pex_violin_abs_1g.png}\end{center}
\subsection*{\normalsize Absolute Error --- Vertical maneuver}
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/pex_violin_abs_Vertical_maneuver.png}\end{center}
\subsection*{\normalsize Absolute Error --- Vertical gust}
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/pex_violin_abs_Vertical_gust.png}\end{center}
\subsection*{\normalsize Absolute Error --- Turn}
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/pex_violin_abs_Turn.png}\end{center}
\subsection*{\normalsize Absolute Error --- Frontal gust}
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/pex_violin_abs_Frontal_gust.png}\end{center}
\subsection*{\normalsize Absolute Error --- n0}
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/pex_violin_abs_n0.png}\end{center}
\subsection*{\normalsize Absolute Error --- Giro}
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/pex_violin_abs_Giro.png}\end{center}
\clearpage
...
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/pey_residue_scatter.png}\end{center}
\exhead{Residue Violin vs True Output Bins}
Bins determined by Sturges rule. Median line dashed at 0.
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/pey_residue_violin.png}\end{center}
\exhead{Absolute Error vs True Output --- Scatter}
Spearman r shown. Red title = significant monotonic trend.
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/pey_abserr_scatter.png}\end{center}
\exhead{Absolute Error Violin vs True Output Bins}
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/pey_abserr_violin.png}\end{center}
\clearpage
...
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/uncertainty_coverage.png}\end{center}
...
\begin{center}\includegraphics[width=1.0\linewidth]{analysis_plots/uncertainty_bounds.png}\end{center}
